...
export default async function NovoServicoPage() {
  ...
  const [empresasRes, gruposRes, subgruposRes, unidadesRes, fornecedoresRes] =
    await Promise.all([
      supabase
        .from("empresas")
        .select("id, nome")
  ...
  async function criarServico(formData: FormData) {
    ...
    const custoUnitario = nullableNumber(formData.get("custo_unitario")) ?? 0;
    ...
    revalidatePath("/dashboard/cadastros/recursos/servicos");
    redirect("/dashboard/cadastros/recursos/servicos");
  }
  ...
  return (
    <div className="space-y-5 p-4 sm:space-y-6 sm:p-6 lg:space-y-8 lg:p-8">
        ...
        <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-relaxed text-white/60 sm:mt-4 sm:text-base">
              Cadastre um novo serviço com grupo, subgrupo, unidade,
              fornecedor, custo unitário e preço.
            </p>
          </div>
      ...
      <form action={criarServico} className="space-y-5 sm:space-y-6">
        <section className="relative overflow-hidden rounded-[20px] border border-white/5 bg-[#252525] p-4 shadow-lg sm:rounded-[28px] sm:p-5 lg:p-6">
          ...
          <div className="relative z-10">
            <SectionTitle
              ...
              description="Preencha os dados principais do serviço."
            />
        ...
        <section className="relative overflow-hidden rounded-[20px] border border-white/5 bg-[#252525] p-4 shadow-lg sm:rounded-[28px] sm:p-5 lg:p-6">
          ...
          <div className="relative z-10">
            <SectionTitle
              title="Descrição"
              description="Detalhes complementares sobre o serviço."
            />
            ...
            <div className="mt-5">
              ...
              <div className="mt-2 flex items-start gap-3 rounded-2xl border border-white/5 bg-white/[0.04] px-4 py-3">
                ...
                <textarea
                  name="descricao"
                  rows={5}
                  placeholder="Descreva o escopo do serviço, observações e detalhes importantes..."
