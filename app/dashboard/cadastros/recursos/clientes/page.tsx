...
export default async function ClientesPage({ searchParams }: PageProps) {
  ...
  const [clientesRes, totalRes, ativosRes, inativosRes] = await Promise.all([
    getClientes({
      supabase,
      userId,
      q,
        ...
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-relaxed text-white/60 sm:mt-4 sm:text-base">
              Gerencie os clientes vinculados aos seus orçamentos e obras com
              dados de contato, documento, endereço e status.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:min-w-[360px]">
            ...
            <MiniStat label="Na listagem" value={String(clientes.length)} highlight />
          </div>
        </div>
      </section>
        ...
        <div className="relative z-10">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="text-sm text-white/50">
                Busque, filtre e acompanhe os clientes cadastrados.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                href="/dashboard/cadastros/recursos/clientes/novo"
          ...
          >
            ...
            >
              ...
              <option value="fisica" className="bg-[#252525]">
                Pessoa física
              </option>
              <option value="juridica" className="bg-[#252525]">
                Pessoa jurídica
              </option>
            </select>
                    ...
                    clientes.map((item) => (
                      ...
                      >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              ...
                              <p className="truncate text-xs text-white/45">
                                {item.empresa?.[0]?.nome ?? "Sem empresa vinculada"}
                              </p>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="px-4 py-4 text-sm text-white/65">
                          {formatTipoPessoa(item.tipo_pessoa)}
                        </td>
                        ...
                        <td className="px-4 py-4 text-sm text-white/65">
                          <div className="inline-flex items-center gap-2">
                            ...
                            {formatCidadeEstado(item.cidade, item.estado)}
                          </div>
                        </td>
...
function formatTipoPessoa(value: string | null) {
  return value === "juridica" ? "Pessoa jurídica" : "Pessoa física";
}
