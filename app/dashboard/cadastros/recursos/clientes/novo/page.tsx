...
export default async function NovoClientePage() {
  ...
  async function criarCliente(formData: FormData) {
    ...
    const tipoPessoa = nullableText(formData.get("tipo_pessoa")) ?? "fisica";
    ...
    revalidatePath("/dashboard/cadastros/recursos/clientes");
    redirect("/dashboard/cadastros/recursos/clientes");
  }
  ...
  return (
    <div className="space-y-5 p-4 sm:space-y-6 sm:p-6 lg:space-y-8 lg:p-8">
        ...
        <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-relaxed text-white/60 sm:mt-4 sm:text-base">
              Cadastre um novo cliente com dados principais, vínculo com
      ...
      <form action={criarCliente} className="space-y-5 sm:space-y-6">
        <section className="relative overflow-hidden rounded-[20px] border border-white/5 bg-[#252525] p-4 shadow-lg sm:rounded-[28px] sm:p-5 lg:p-6">
          ...
          <div className="relative z-10">
            <SectionTitle
              ...
              description="Preencha os dados base para o cadastro do cliente."
            />
        ...
        <section className="relative overflow-hidden rounded-[20px] border border-white/5 bg-[#252525] p-4 shadow-lg sm:rounded-[28px] sm:p-5 lg:p-6">
          ...
          <div className="relative z-10">
            <SectionTitle
              title="Observações"
              description="Anotações adicionais sobre esse cliente."
            />
