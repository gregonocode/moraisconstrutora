...
export default async function EquipamentosPage({ searchParams }: PageProps) {
  ...
  const [equipamentosRes, gruposRes, totalRes, ativosRes, inativosRes] =
    await Promise.all([
      getEquipamentos({
        supabase,
        userId,
  ...
  if (equipamentosRes.error) {
    throw new Error(
      `Erro ao carregar equipamentos: ${equipamentosRes.error.message}`
    );
  }
  ...
  const equipamentos = (equipamentosRes.data ?? []) as EquipamentoRow[];
        ...
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-relaxed text-white/60 sm:mt-4 sm:text-base">
              Gerencie os equipamentos da operação com grupo, fornecedor,
              unidade, preço e tipo de controle.
            </p>
          </div>
      ...
      <section className="relative overflow-hidden rounded-[20px] border border-white/5 bg-[#252525] p-4 shadow-lg sm:rounded-[28px] sm:p-5 lg:p-6">
        ...
        <div className="relative z-10">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="text-sm text-white/50">
                Busque, filtre e gerencie os equipamentos cadastrados.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                href="/dashboard/cadastros/recursos/equipamentos/novo"
                  ...
                  {equipamentos.length === 0 ? (
                    ...
                    equipamentos.map((item) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 text-sm text-white/65 capitalize">
                          {item.tipo_controle ?? "-"}
                        </td>
          ...
          <div className="mt-4 flex flex-col gap-3 text-sm text-white/45 sm:flex-row sm:items-center sm:justify-between">
            <p>Mostrando {equipamentos.length} equipamentos</p>
